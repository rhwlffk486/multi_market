...
function formOnclick() {
	...
	if (imgTest == 'jpg' || imgTest == 'jpeg' || imgTest == 'gif' || imgTest == 'png' || imgTest == 'bmp' || imgTest == 'jfif') {
	} else {
	...
	if (cateSelect2 == true && productTitle == true && productPrice == true && productContent == true && productImg == true && produtQty == true) {
		alert('물품 등록 완료하였습니다.');
		return true;
	} else {
		alert('내용을 확인해주세요.');
...
<body>
	...
	<main>
		<div id="uplode_title">
			<h3 id="uplode_h3">상품등록</h3>
		</div>
		<form id="uplode_form" method="post" enctype="multipart/form-data" action="/shopping/productUpload">
			<input type="hidden" name="role" value="${userVO.role }">
			<div class="uplode form_row">
				...
				<div class="uplode_form Uname">
					<label for="product_title"><strong>상품명</strong></label> 
					<span class="uplode_check Pname">상품명을 입력해주세요.</span> 
					<input type="text" name="productTitle" class="form-control" id="product_title" placeholder="상품명 입력">
				</div>

				<div class="uplode_form Uqty">
					<span class="uplode_check Pqty">수량을 입력해주세요.</span> 
					<label for="product_qty"><strong>상품 수량</strong></label> 
					<input type="text" name="productQty" class="form-control" id="product_qty" placeholder="가격">
				</div>
				...
				<div class="uplode_form Uprice">
					...
					<input type="text" name="productPrice" class="form-control" id="product_price" placeholder="가격">
				</div>
				...
				<div class="uplode_form Uimg">
					...
					<input type="file" name="productImg" id="product_img" accept=".jpg, .jpeg, .gif, .png, .bmp, .jfif"> 
					<span class="uplode_check Pimg_type">이미지는 jpg, jpeg, gif, png, bmp, jfif만 가능합니다.</span>
				</div>
			</div>
			<div class="uplode_form Ubtn">
				<input type="submit" id="upload_btn" value="상품 등록" onclick="return formOnclick();">
