...
if ("${result}" == 2) {
	alert("회원가입에 실패했습니다. 하단 관리자 번호나 Email로 문의해주세요.");
}
	...
	$(function() {
		...
		$("#user_ID").keyup(function() {
			...
			if (idJ.test(id)&& empJ.test(id) == false) {
				...
				document.getElementById('idCheck').innerHTML = "4~12자 사이 소문자와 숫자만 가능합니다.";
				document.getElementById('idCheck').style.color = "red";
				idCheck = false;
			}
		});
						...
						<table>
							<tbody>
								...
								<tr>
									...
									<td><input type="text" class="td_input_sign_up" id="phone" name="phone" maxlength="13"></td>
								...
								<tr>
									<th></th>
									<td><input type="text" name="userAddress2" id="userAddress2" placeholder="주소 입력" readonly class='box' /></td>
								...
								<tr>
									...
									<td><input type="text" class="form-control" id="business_number" name="businessNumber" maxlength="12"></td>
								...
								<tr>
									...
									<td><input type="text" id="BKname" name="BKname" placeholder="은행이름">
									<input type="text" id="account" name="account" class="form-control" required></td>
